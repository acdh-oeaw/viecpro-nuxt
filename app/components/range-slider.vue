...
<template>
	<div class="flex flex-col gap-2">
		<div class="my-1 flex justify-between">
			<div>
				<label class="sr-only" for="start_year">Select start year</label>
				<input
					id="start_year"
			...
			<div>
				<label class="sr-only" for="end_year">Select end year</label>
				<input
					id="end_year"
		...
		>
			...
			<SliderThumb
				class="block size-5 rounded-l-full border border-primary-600 bg-white shadow hover:bg-primary-200 active:bg-primary-300"
			/>
			<SliderThumb
				class="block size-5 rounded-r-full border border-primary-600 bg-white shadow hover:bg-primary-200 active:bg-primary-300"
			/>
		</SliderRoot>
