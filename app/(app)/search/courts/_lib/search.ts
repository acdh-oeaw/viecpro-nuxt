...
export async function getSearchResults(
	 ...
	 */
	const response = await client.multiSearch.perform<Array<Court>>(
		{ searches },
		{
			collection,
...
export async function downloadCollection(
	...
	const searchResponse = await client.multiSearch.perform<Array<Court>>(
		{
