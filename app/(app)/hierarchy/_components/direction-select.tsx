...
export function DirectionSelect(props: DirectionSelectProps): ReactNode {
	...
	return (
		<Select className="grid gap-y-1" name={name} onChange={onSelectionChange} value={selectedKey}>
			...
			<Button className="inline-flex w-full items-center justify-between gap-x-2.5 rounded-md border border-brand-100 bg-white py-2.5 pr-3 pl-4 leading-none focus-visible:focus-outline focus-visible:focus-outline-offset-0 disabled:cursor-not-allowed sm:min-w-40">
