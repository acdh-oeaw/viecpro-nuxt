...
export function TailwindIndicator(): ReactNode {
	...
	return (
		<div className="fixed bottom-4 right-4 z-10 grid size-8 cursor-default select-none place-content-center rounded-full bg-black font-mono text-sm font-bold text-white shadow-lg">
