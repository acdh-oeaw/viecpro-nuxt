...
import roboto from "@fontsource-variable/roboto-flex/files/roboto-flex-latin-standard-normal.woff2?url";
...
useHead({
	...
	link: computed(() => {
		return [
			...
			{ href: roboto, rel: "preload", as: "font", type: "font/woff2", crossorigin: true },
			...(i18nHead.value.link ?? []),
		];
	}),
	meta: computed(() => {
