...
export function Collapsible(props: CollapsibleProps): ReactNode {
	...
	return (
		...
		>
			<Heading>
				<Button
					className="group inline-flex w-full items-center justify-between rounded-md border border-brand-200 bg-brand-100 px-3 py-2 font-medium text-brand-900 transition group-expanded:border-brand-300 group-expanded:bg-brand-200 hover:border-brand-300 hover:bg-brand-200 disabled:cursor-not-allowed disabled:border-neutral-200 disabled:bg-transparent disabled:text-neutral-500"
					slot="trigger"
				>
					{label}
					<ChevronDownIcon
